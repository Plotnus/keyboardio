...
KEYMAPS(
  ...
  [COLMAK_DH] = KEYMAP_STACKED(
    ...
    LockLayer(COLMAK_DH),   Key_6, Key_7, Key_8, Key_9, Key_0, XXX,
    Key_Enter,     Key_J, Key_L, Key_U,     Key_Y,         Key_Semicolon, Key_Equals,
                   Key_K, Key_N, Key_E,     Key_I,         Key_O,         Key_Quote,
    Key_RightAlt,  Key_M, Key_H, Key_Comma, Key_Period,    Key_Slash,     Key_Minus,
    Key_RightAlt, Key_RightControl, Key_Spacebar, Key_RightShift,
    ShiftToLayer(FUNCTION)
  ),
  ...
  [WORKMAN] = KEYMAP_STACKED(
    ...
    XXX,   Key_6, Key_7, Key_8, Key_9, Key_0, LockLayer(WORKMAN),
  ...
  //  ___,     Key_6, Key_7, Key_8, Key_9, ___,     ___,
  //  ___, ___, ___, ___,
  //  ___,
  //  // right
  //  ___,     ___, ___, ___, ___, ___,     ___,
